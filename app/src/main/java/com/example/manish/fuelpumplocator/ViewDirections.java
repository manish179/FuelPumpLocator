...
import com.example.manish.fuelpumplocator.Helper.DirectionJSONParser;
...
public class ViewDirections extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void buildLocationCallBack() {
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                //create marker for destination marker
    ...
    private void drawPath(Location mLastLocation, com.example.manish.fuelpumplocator.Model.Location location) {
